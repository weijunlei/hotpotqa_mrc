...
MODEL_NAME=ElectraForQuestionAnsweringQA

# truly train setting
TRAIN_DIR=../../data/checkpoints/20220103_forward_best_pretrain_step
...
TRAIN_LOG=20220103_forward_best_pretrain_step
TRAIN_CACHE=../../data/cache/20220103_forward_best_pretrain_step
