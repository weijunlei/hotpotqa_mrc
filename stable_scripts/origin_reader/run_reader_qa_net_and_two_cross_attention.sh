...
TRAIN_DIR=../../data/checkpoints/20220105_qa_net_lr_15
...
TRAIN_LOG=20220105_qa_net_lr_15
TRAIN_CACHE=../../data/cache/20220105_qa_net_lr_15
...
TRAIN_DIR=../../data/checkpoints/20220105_two_true_cross_attention
TRAIN_TRAIN_FILE=../../data/hotpot_data/hotpot_train_labeled_data_v3.json
TRAIN_DEV_FILE=../../data/hotpot_data/hotpot_dev_labeled_data_v3.json
TRAIN_LOG=20220105_two_true_cross_attention
TRAIN_CACHE=../../data/cache/20220105_two_true_cross_attention
python -u origin_reader_model.py \
  --bert_model $BERT_MODEL \
  --output_dir $TRAIN_DIR \
  --model_name $MODEL_NAME \
