...
python -u origin_reader_model.py \
  ...
  --log_prefix 20211220_sent_loss_20_2e_bert_qa_net_attention_add_gelu_act_with_weight_co_cross_cross_electra_selector \
  ...
  --feature_cache_path ../../data/cache/20211220_sent_loss_20_2e_bert_qa_net_attention_with_weight_co_cross_cross_electra_selector \
  --train_batch_size 8 \
