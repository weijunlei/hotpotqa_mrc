...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211228_qa_net_two_origin_small_cross \
  --model_name BertForQuestionAnsweringQANet \
  --log_prefix 20211228_qa_net_two_origin_small_cross \
  ...
  --feature_cache_path ../../data/cache/20211228_qa_net_two_origin_small_cross \
  --train_batch_size 4 \
