...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211230_qa_net_two_can_double \
  --model_name BertForQuestionAnsweringQANetDoubleCan \
  --log_prefix 20211230_qa_net_two_can_double \
  ...
  --feature_cache_path ../../data/cache/20211230_qa_net_two_can_double \
  --train_batch_size 4 \
