...
TRAIN_DIR=../../data/checkpoints/2022_two_true_cross_attention_bs16
...
TRAIN_LOG=2022_two_true_cross_attention_bs16
TRAIN_CACHE=../../data/cache/2022_two_true_cross_attention_bs16
...
TRAIN_DIR=../../data/checkpoints/2022_two_fake_cross_attention_bs16
TRAIN_TRAIN_FILE=../../data/hotpot_data/hotpot_train_labeled_data_v3.json
TRAIN_DEV_FILE=../../data/hotpot_data/hotpot_dev_labeled_data_v3.json
TRAIN_LOG=2022_two_fake_cross_attention_bs16
TRAIN_CACHE=../../data/cache/2022_two_fake_cross_attention_bs16
# model choice BertForQuestionAnsweringCoAttention,
               # BertForQuestionAnsweringThreeCoAttention,
               # BertForQuestionAnsweringThreeSameCoAttention,
               # BertForQuestionAnsweringForward
