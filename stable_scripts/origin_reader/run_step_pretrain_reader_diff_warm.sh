...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211227_electra_large_trained_origin \
  ...
  --log_prefix 20211227_electra_large_trained_origin \
  --overwrite_result True \
  --train_file ../../data/hotpot_data/hotpot_dev_labeled_data_v3.json \
  ...
  --feature_cache_path ../../data/cache/20211227_electra_large_trained_origin \
  --train_batch_size 12 \
