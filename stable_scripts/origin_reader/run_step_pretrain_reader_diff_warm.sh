...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211227_electra_large_trained_origin_5warm \
  ...
  --log_prefix 20211227_electra_large_trained_origin_5warm \
  ...
  --feature_cache_path ../../data/cache/20211227_electra_large_trained_origin_5warm \
  --train_batch_size 12 \
...
python -u origin_reader_model.py \
  --bert_model google/electra-large-discriminator \
  --output_dir ../../data/checkpoints/20211227_electra_large_trained_origin_5warm_epoch2 \
  --checkpoint_path ../../data/checkpoints/20211225_electra_large_dynamic_weight_bs12_pre_trained \
  --model_name ElectraForQuestionAnsweringQANet \
  --log_prefix 20211227_electra_large_trained_origin_5warm_epoch2 \
  --overwrite_result True \
  --train_file ../../data/hotpot_data/hotpot_train_labeled_data_v3.json \
  --dev_file ../../data/hotpot_data/hotpot_dev_labeled_data_v3.json \
  --train_supporting_para_file ../../data/hotpot_data/train_golden.json \
  --dev_supporting_para_file ../../data/selector/20211217_second_hop_electra_base_just_paragraph_selector_12_value_setting_result/dev_related.json \
  --feature_cache_path ../../data/cache/20211227_electra_large_trained_origin_5warm_epoch2 \
  --train_batch_size 12 \
  --gradient_accumulation_steps 1 \
  --warmup_proportion 0.05 \
  --local_rank -1 \
