...
python -u first_select_trainer.py \
    ...
    --world_size 1 \
    --local_rank -1 \
    --feature_cache_path ../../data/cache/selector/20211117_roberta_large_naive \
    --log_prefix 20211117_roberta_large_naive \
    --log_path ../../log \
    --output_dir ../../data/checkpoints/selector/20211117_roberta_large_naive \
