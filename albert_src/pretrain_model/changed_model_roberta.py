...
from transformers import ElectraModel, AlbertModel, BertModel, RobertaModel, AlbertPreTrainedModel
...
class AlbertForQuestionAnsweringQANet(AlbertPreTrainedModel):
    def __init__(self, config):
