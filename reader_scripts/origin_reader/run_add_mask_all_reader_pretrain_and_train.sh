...
PRETRAIN_LOG=20211231_electra_large_with_mask_wo_weight_pretrain
...
PRETRAIN_CACHE=../../data/cache/20211231_electra_large_with_mask_wo_weight_pretrain
PRETRAIN_DIR=../../data/checkpoints/20211231_electra_large_with_mask_wo_weight_pretrain

# truly train setting
TRAIN_DIR=../../data/checkpoints/20211231_electra_large_with_mask_wo_weight_pretrain_step
...
TRAIN_LOG=20211231_electra_large_with_mask_wo_weight_pretrain_step
TRAIN_CACHE=../../data/cache/20211231_electra_large_with_mask_wo_weight_pretrain_step
