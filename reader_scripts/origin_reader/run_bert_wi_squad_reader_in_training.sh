...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20220108_bs8_with_squad_in_training_bert_qanet \
  --model_name BertForQuestionAnsweringQANet \
  --log_prefix 20220108_bs8_with_squad_in_training_bert_qanet \
  --overwrite_result True \
  --train_file ../../data/hotpot_data/hotpot_train_labeled_data_with_squad.json \
  ...
  --feature_cache_path ../../data/cache/20220108_bs8_with_squad_in_training_bert_qanet \
  --train_batch_size 8 \
