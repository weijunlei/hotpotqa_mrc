...
# truly train setting
MODEL_NAME=ElectraForQuestionAnsweringCoAttention
TRAIN_DIR=../../data/checkpoints/20220104_co_attention
...
TRAIN_LOG=20220104_co_attention
TRAIN_CACHE=../../data/cache/20220104_co_attention
...
# truly train setting
MODEL_NAME=ElectraForQuestionAnsweringFFN
TRAIN_DIR=../../data/checkpoints/20220104_ffn
TRAIN_TRAIN_FILE=../../data/hotpot_data/hotpot_train_labeled_data_v3.json
TRAIN_DEV_FILE=../../data/hotpot_data/hotpot_dev_labeled_data_v3.json
TRAIN_LOG=20220104_ffn
TRAIN_CACHE=../../data/cache/20220104_ffn
# model choice BertForQuestionAnsweringCoAttention,
               # BertForQuestionAnsweringThreeCoAttention,
               # BertForQuestionAnsweringThreeSameCoAttention,
               # BertForQuestionAnsweringForward
