...
TRAIN_DIR=../../data/checkpoints/20220122_run_qanet_only_train_bs8
...
TRAIN_LOG=20220122_run_qanet_only_train_bs8
TRAIN_CACHE=../../data/cache/20220122_run_qanet_only_train_bs8
...
PRETRAIN_LOG=20220122_run_qanet_pretrain_bs8_pretrain
...
PRETRAIN_CACHE=../../data/cache/20220122_run_qanet_pretrain_bs8_pretrain
PRETRAIN_DIR=../../data/checkpoints/20220122_run_qanet_pretrain_bs8_pretrain

# truly train setting
TRAIN_DIR=../../data/checkpoints/20220122_run_qanet_pretrain_bs8_pretrain_step
TRAIN_TRAIN_FILE=../../data/hotpot_data/hotpot_train_labeled_data_v3.json
TRAIN_DEV_FILE=../../data/hotpot_data/hotpot_dev_labeled_data_v3.json
TRAIN_LOG=20220122_run_qanet_pretrain_bs8_pretrain_step
TRAIN_CACHE=../../data/cache/20220122_run_qanet_pretrain_bs8_pretrain_step
