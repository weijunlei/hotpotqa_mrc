...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220120_replace_albert_xxlarge_forward_best_only_train_wi_token_helper
...
TRAIN_LOG=20220120_replace_albert_xxlarge_forward_best_only_train_wi_token_helper
TRAIN_CACHE=../../data/cache/20220120_replace_albert_xxlarge_forward_best_only_train_wi_token_helper
