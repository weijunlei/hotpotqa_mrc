...
TRAIN_DIR=../../data/checkpoints/20220129_add_e_run_qanet_only_train_bs12_lr10_with_mask
...
TRAIN_LOG=20220129_add_e_run_qanet_only_train_bs12_lr10_with_mask
TRAIN_CACHE=../../data/cache/20220129_add_e_run_qanet_only_train_bs12_lr10_with_mask
...
PRETRAIN_LOG=20220129_add_e_run_qanet_pretrain_bs12_lr10_with_mask
...
PRETRAIN_CACHE=../../data/cache/20220129_add_e_run_qanet_pretrain_bs12_lr10_with_mask
PRETRAIN_DIR=../../data/checkpoints/20220129_add_e_run_qanet_pretrain_bs12_lr10_with_mask

# truly train setting
TRAIN_DIR=../../data/checkpoints/20220129_add_e_run_qanet_pretrain_bs12_lr10_with_mask_step
TRAIN_TRAIN_FILE=../../data/hotpot_data/hotpot_train_labeled_data_v3.json
TRAIN_DEV_FILE=../../data/hotpot_data/hotpot_dev_labeled_data_v3.json
TRAIN_LOG=20220129_add_e_run_qanet_pretrain_bs12_lr10_with_mask_step
TRAIN_CACHE=../../data/cache/20220129_add_e_run_qanet_pretrain_bs12_lr10_with_mask_step
...
cd ../../albert_add_e_replace_src/origin_reader
python -u origin_reader_model.py \
  --bert_model $BERT_MODEL \
