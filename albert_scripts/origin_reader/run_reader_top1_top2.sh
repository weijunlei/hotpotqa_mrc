...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220104_train_top1
...
TRAIN_LOG=20220104_train_top1
TRAIN_CACHE=../../data/cache/20220104_train_top1
...
python -u origin_reader_model.py \
  ...
  --dev_supporting_para_file ../../data/selector/20220104_first_hop_selector_result/dev_top1_related.json \
...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220104_train_top2
TRAIN_TRAIN_FILE=../../data/hotpot_data/hotpot_train_labeled_data_v3.json
TRAIN_DEV_FILE=../../data/hotpot_data/hotpot_dev_labeled_data_v3.json
TRAIN_LOG=20220104_train_top2
TRAIN_CACHE=../../data/cache/20220104_train_top2
# model choice BertForQuestionAnsweringCoAttention,
               # BertForQuestionAnsweringThreeCoAttention,
               # BertForQuestionAnsweringThreeSameCoAttention,
               # BertForQuestionAnsweringForward
...
python -u origin_reader_model.py \
  ...
  --dev_file  $TRAIN_DEV_FILE \
  --train_supporting_para_file ../../data/hotpot_data/train_golden.json \
  --dev_supporting_para_file ../../data/selector/20220104_first_hop_selector_result/dev_top2_related.json \
  --feature_cache_path $TRAIN_CACHE \
  --train_batch_size 16 \
  --warmup_proportion 0.1 \
  --gradient_accumulation_steps 1 \
