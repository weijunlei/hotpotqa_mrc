...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220108_qanet_wa
...
TRAIN_LOG=20220108_qanet_wa
TRAIN_CACHE=../../data/cache/20220108_qanet_wa
...
python -u origin_reader_model.py \
  ...
  --dev_supporting_para_file ../../data/selector/20220105_second_regression_selector_result/dev_related.json \
