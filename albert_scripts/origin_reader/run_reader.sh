...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211223_albert_xxlarge_dynamic_weight \
  --model_name AlbertForQuestionAnsweringQANet \
  --log_prefix 20211223_albert_xxlarge_dynamic_weight \
  ...
  --feature_cache_path ../../data/cache/20211223_albert_xxlarge_dynamic_weight \
  --train_batch_size 10 \
