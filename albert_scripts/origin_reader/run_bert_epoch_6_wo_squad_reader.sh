...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20220108_epoch_6_bert_qanet \
  --model_name BertForQuestionAnsweringQANet \
  --log_prefix 20220108_epoch_6_bert_qanet \
  ...
  --feature_cache_path ../../data/cache/20220108_epoch_6_bert_qanet \
  --train_batch_size 8 \
