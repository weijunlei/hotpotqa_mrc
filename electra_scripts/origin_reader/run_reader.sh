...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211208_sent_loss20_electra_three_large_cross_attention_3e_train_golden \
  --model_name ElectraForQuestionAnsweringThreeCrossAttention \
  --log_prefix 20211208_sent_loss20_electra_three_large_cross_attention_3e_train_golden \
  ...
  --feature_cache_path ../../data/cache/20211207_sent_loss20_electra_large_match_attention_3e_train_golden \
  --train_batch_size 12 \
