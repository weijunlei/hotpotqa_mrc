...
python -u origin_reader_model.py \
  ...
  --log_prefix 20211219_sent_loss_20_2e_electra_large_qa_net_weighted_wo_bi_with_co_cross_with_electra_selector \
  ...
  --train_supporting_para_file ../../data/selector/20211217_second_hop_electra_base_just_paragraph_selector_12_value_setting_test_result/train_three_filtered_related.json \
  --dev_supporting_para_file ../../data/selector/20211217_second_hop_electra_base_just_paragraph_selector_12_value_setting_test_result/dev_three_filtered_related.json \
  --feature_cache_path ../../data/cache/20211219_sent_loss_20_2e_electra_large_qa_net_weighted_wo_bi_with_co_cross_with_electra_selector \
  --train_batch_size 12 \
