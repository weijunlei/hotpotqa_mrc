...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211207_sent_loss20_electra_large_forwardbest_3e_train_golden_with_squad_data \
  --model_name ElectraForQuestionAnsweringForwardBest \
  --log_prefix 20211207_sent_loss20_electra_large_forwardbest_3e_train_golden_with_squad_data \
  ...
  --feature_cache_path ../../data/cache/20211207_sent_loss20_electra_large_forwardbest_3e_train_golden_with_squad_data \
  --train_batch_size 12 \
  --local_rank -1 \
  --learning_rate 3e-5 \
  --val_batch_size 64 \
