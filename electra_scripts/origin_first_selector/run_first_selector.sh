...
python -u first_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/20211122_first_hop_just_paragraph_selector_test \
    --feature_cache_path ../../data/cache/selector/20211122_first_hop_selector \
