...
#    --world_size 2 \
#    --local_rank 0 \
#    --feature_cache_path ../../data/cache/selector/20211108_roberta_large_naive \
#    --log_prefix 20211108_roberta_large_naive \
#    --log_path ../../log \
#    --output_dir ../../data/checkpoints/selector/20211108_roberta_large_first_hop_just_paragraph_selector_naive \
...
#    --checkpoint_path ../../data/checkpoints/selector/20211108_roberta_large_first_hop_just_paragraph_selector_naive \
...
#    --predict_result_path ../../data/selector/20211108_roberta_first_hop_large_related_paragraph_result/ \
...
python -u second_select_trainer.py \
    ...
    --world_size 2 \
    --local_rank -1 \
    --feature_cache_path ../../data/cache/selector/20211108_second_roberta_large_naive \
    --log_prefix 20211108_second_roberta_large_naive \
    --log_path ../../log \
    --output_dir ../../data/checkpoints/selector/20211108_roberta_large_second_hop_just_paragraph_selector_test \
    --first_predict_result_path ../../data/selector/20211108_roberta_first_hop_large_related_paragraph_result \
...
python -u second_select_predictor.py \
    --bert_model roberta-base \
    --checkpoint_path ../../data/checkpoints/selector/20211108_roberta_large_second_hop_just_paragraph_selector_test \
    --feature_cache_path ../../data/cache/20211108_roberta_large_second_hop_just_paragraph_selector_test/ \
    --log_prefix 20211108_roberta_large_second_hop_just_paragraph_selector_test \
    --log_path ../../log \
    --model_name RobertaForParagraphClassification \
    --predict_file ../../data/hotpot_data/hotpot_dev_labeled_data_v3.json \
    --predict_result_path ../../data/selector/roberta_large_second_hop_related_paragraph_result/ \
    --first_predict_result_path ../../data/selector/20211108_roberta_first_hop_large_related_paragraph_result \
    --best_paragraph_file dev_best_paragraph.json \
