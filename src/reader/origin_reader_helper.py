...
class HotpotQAReaderExample(object):
    """HotpotQA Reader"""
    ...
    def __init__(self,
                 ...
                 full_sentences_mask=None,
                 full_sentences_labels=None,
                 mask_matrix=None,
                 subword2matrix=None):
        self.qas_id = qas_id
        ...
        self.subword2origin_index = subword2origin_index
        self.start_position = start_position
        self.end_position = end_position
        self.sentence_cls = sentence_cls
        self.sentence_labels = sentence_labels
        self.full_sentences_mask = full_sentences_mask
        self.full_sentences_labels = full_sentences_labels
        self.mask_matrix = mask_matrix
        self.subword2matrix = subword2matrix
...
class HotpotQAInputFeatures(object):
    def __init__(self,
                 unique_id,
                 example_index,
                 doc_span_index,
        ...
        self.tokens = tokens
        self.token2origin_map = token2origin_map
...
def evaluate(eval_examples, answer_dict, sp_preds):
    ...
    for ee in eval_examples:
        ...
        ans_em+=a_em
        s_f1,s_em,s_prec,s_recall=update_sp(sp_preds[ee.qas_id],ee.full_sentences_labels)
        sp_f1+=s_f1
        sp_em+=s_em
