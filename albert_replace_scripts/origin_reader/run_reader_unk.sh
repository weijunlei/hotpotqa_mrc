...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220108_qanet_unk
...
python -u origin_reader_model.py \
  ...
  --dev_supporting_para_file ../../data/selector/20220105_second_selector_no_unk_result/dev_related.json \
