...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220109_qanet_wa_fg_epoch10_mask
...
TRAIN_LOG=20220109_qanet_wa_fg_epoch10_mask
TRAIN_CACHE=../../data/cache/20220109_qanet_wa_fg_epoch10_mask
...
python -u origin_reader_model.py \
  ...
  --dev_supporting_para_file ../../data/selector/20220109_second_fine_grain_epoch10_result/dev_related.json \
