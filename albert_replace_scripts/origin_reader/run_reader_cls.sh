...
# truly train setting
TRAIN_DIR=../../data/checkpoints/20220108_qanet_cls
...
TRAIN_LOG=20220108_qanet_cls
TRAIN_CACHE=../../data/cache/20220108_qanet_unk
...
python -u origin_reader_model.py \
  ...
  --dev_supporting_para_file ../../data/selector/20220105_special_token_cls_second_selector_result/dev_related.json \
