...
PRETRAIN_LOG=20220120_run_qanet_pretrain
...
PRETRAIN_CACHE=../../data/cache/20220120_run_qanet_pretrain
PRETRAIN_DIR=../../data/checkpoints/20220120_run_qanet_pretrain

# truly train setting
TRAIN_DIR=../../data/checkpoints/20220120_run_qanet_pretrain_step
...
TRAIN_LOG=20220120_run_qanet_pretrain_step
TRAIN_CACHE=../../data/cache/20220120_run_qanet_pretrain_step
