...
python -u first_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/20211210_first_hop_related_paragraph_selector_test_bs8 \
    --log_path ../../log \
    --log_prefix 20211210_first_hop_related_paragraph_selector_test_bs8 \
