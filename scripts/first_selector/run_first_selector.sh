...
python -u first_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/2021_1207_first_hop_related_paragraph_selector \
    --feature_cache_path ../../data/cache/selector/2021_1207_first_hop_related_paragraph_selector \
