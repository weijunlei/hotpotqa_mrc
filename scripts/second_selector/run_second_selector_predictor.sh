...
FIRST_PREDICT_PATH=../../data/selector/20211214_first_hop_just_paragraph_result/
...
SECOND_PREDICT_PATH=../../data/selector/20211220_second_just_paragraph_hop_selector_truly_debug_result
cd ../../src/selector
