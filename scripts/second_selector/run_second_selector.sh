...
python -u second_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/20211210_second_related_paragraph_hop_selector_truly \
    --feature_cache_path ../../data/cache/selector/20211210_second_related_paragraph_hop_selector_truly \
    --log_prefix 20211210_second_related_paragraph_hop_selector_truly \
    --model_name BertForRelatedSentence \
    --train_file ../../data/hotpot_data/hotpot_train_labeled_data_v3.json \
    --dev_file ../../data/hotpot_data/hotpot_dev_labeled_data_v3.json \
    --first_predict_result_path ../../data/selector/20211209_first_hop_related_paragraph_result/ \
