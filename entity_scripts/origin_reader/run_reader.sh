...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/qa_base_20211021_with_entity \
  --model_name BertForQuestionAnsweringForward \
  --log_prefix qa_base_20211021_with_entity \
  ...
  --feature_cache_path ../../data/cache/qa_base_20211021_with_entity \
  --train_batch_size 8 \
  --local_rank -1 \
  --val_batch_size 64 \
