...
def get_config():
    ...
    parser.add_argument("--best_paragraph_path", default="best_paragraph.json")
    ...
    parser.add_argument("--first_predict_result_path",
                        default='../../data/selector/roberta_first_hop_related_paragraph_result/',
                        type=str)
