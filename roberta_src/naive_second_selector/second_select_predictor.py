...
def evaluate_result(args, paragraph_results, thread=0.5):
    ...
    format_result = {}
    best_paragraph_file = os.path.join(args.first_predict_result_path, args.best_paragraph_path)
    ...
    best_relate_paragraph_file = os.path.join(args.predict_path, args.related_file)
    all_paragraph_file = os.path.join(args.predict_path, args.all_paragraph_file)
