...
import pickle
import gc
from transformers import ElectraTokenizer, BertTokenizer, RobertaTokenizer, AlbertTokenizer, DebertaV2Tokenizer
...
from changed_model_roberta import ElectraForQuestionAnsweringForwardWithEntity, ElectraForQuestionAnsweringForwardBest, \
    ...
    ElectraForQuestionAnsweringQANetDoubleCan, ElectraForQuestionAnsweringQANetWithSentWeight, DebertaForQuestionAnsweringQANet
...
def run_train(rank=0, world_size=1):
    ...
    if 'electra' in args.bert_model.lower():
        ...
        tokenizer = DebertaV2Tokenizer.from_pretrained(args.bert_model, do_lower_case=args.do_lower_case)
