...
python -u first_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/20211124_first_hop_just_paragraph_electra_base_test \
    --feature_cache_path ../../data/cache/selector/20211124_first_hop_just_paragraph_electra_base_test \
