...
python -u second_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/20211212_second_paragraph_hop_selector \
    --feature_cache_path ../../data/cache/selector/20211212_second_paragraph_hop_selector \
