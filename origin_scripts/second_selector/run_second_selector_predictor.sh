...
python -u second_hop_selector_predictor.py \
    ...
    --checkpoint_path ../../data/checkpoints/selector/20211212_second_paragraph_hop_selector \
    --model_name BertForRelatedSentence \
    --dev_file ../../data/hotpot_data/hotpot_dev_labeled_data_v3.json \
    --first_predict_result_path ../../data/selector/first_hop_related_paragraph_result/ \
    --second_predict_result_path ../../data/selector/20211212_second_hop_related_paragraph_result/ \
