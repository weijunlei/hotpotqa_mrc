...
from changed_model import BertForRelatedSentence, BertForParagraphClassification, BertForRelatedSentenceWithCrossAttention
...
def run_predict(args):
    ...
    for start_idx in range(len(start_idxs)):
        ...
        dev_data = TensorDataset(d_all_input_ids, d_all_input_mask, d_all_segment_ids, d_pq_end_pos, d_all_example_index)
        if args.local_rank == -1:
