...
python -u first_hop_selector.py \
    ...
    --output_dir ../../data/checkpoints/selector/20211217_first_hop_roberta_related_paragraph_selector_12_value_setting \
    --log_path ../../log \
    --log_prefix 20211217_first_hop_roberta_related_paragraph_selector_12_value_setting \
    --feature_cache_path ../../data/cache/selector/20211217_first_hop_roberta_related_paragraph_selector_12_value_setting \
