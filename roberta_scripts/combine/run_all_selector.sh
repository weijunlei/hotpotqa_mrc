...
python -u first_hop_selector.py \
    ...
    --use_ddp True \
    --world_size 2 \
    --log_prefix 20211103_first_selector_roberta_large \
    --log_path ../../log \
    --output_dir ../../data/checkpoints/selector/20211103_first_selector_roberta_large \
...
python -u first_hop_selector_predictor.py \
    --bert_model roberta-large \
    --checkpoint_path ../../data/checkpoints/selector/20211103_first_selector_roberta_large \
...
python -u second_hop_selector.py \
    ...
    --log_path ../../log \
    --output_dir ../../data/checkpoints/selector/20211103_roberta_second_paragraph_hop_selector \
...
python -u second_hop_selector_predictor.py \
    --bert_model roberta_large \
     --log_prefix 20211103_roberta_second_hop_selector \
     --log_path ../../log \
    --checkpoint_path ../../data/checkpoints/selector/20211103_roberta_second_paragraph_hop_selector \
    --model_name RobertaForRelatedSentence \
    --dev_file ../../data/hotpot_data/hotpot_train_labeled_data_v3.json \
