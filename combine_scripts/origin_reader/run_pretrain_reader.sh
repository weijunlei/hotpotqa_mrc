...
python -u origin_reader_model.py \
  ...
  --output_dir ../../data/checkpoints/20211225_electra_large_dynamic_weight_bs12_pre_trained \
  --model_name ElectraForQuestionAnsweringQANet \
  --log_prefix 20211225_electra_large_dynamic_weight_bs12_pre_trained \
  ...
  --feature_cache_path ../../data/cache/20211225_electra_large_dynamic_weight_bs12_pre_trained \
  --train_batch_size 12 \
